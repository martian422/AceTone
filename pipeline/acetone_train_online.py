...
from dataset.qwen_data.data_acetone import make_supervised_data_module
...
def train(attn_implementation="flash_attention_2"):
    ...
    if "qwen2.5" in model_args.model_name_or_path.lower() or "acetone" in model_args.model_name_or_path.lower():
